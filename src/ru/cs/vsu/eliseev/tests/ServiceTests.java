...
public class ServiceTests {
    ...
    public void removeChannelWithShows() {
        ...
        channelService.add(newChannel);
        TVShow newShow = new TVShow(14, "Show for remove", DayOfWeek.SUNDAY, "11:30", "12:00", "Show", 15);
        tvShowService.add(newShow);
    ...
    public void removeTVShow() {
        ...
        channelService.add(newChannel);
        TVShow newTVShow = new TVShow(16, "Delete", DayOfWeek.SUNDAY, "14:00", "14:30", "test remove", 16);
